...
import {GridLayout, GridItem} from "../layout/GridLayout";
	...
	render() {
		return(
			<FlexLayout justify="center">
				<GridLayout gutterWidth={30} columnWidth={380} align="center" style={{width: '100%'}}>
					<GridItem columnSpan={1}>
						<div style={this.styles.card}>
							...
							<FlexLayout justify="end" style={{marginTop: 10}}>
					...
					<GridItem columnSpan={2}>
						<div style={this.styles.card}>
							...
							<p style={this.styles.para}>
								...
								Android and recently ported tro the web using Html5 apis. The online version of the game is written in typescript 
								and uses the canvas api to render graphics. The source code is available on GitHub for inspection and experimentation.  
							</p>

							<FlexLayout justify="end" style={{marginTop: 10}}>
								<a key="0_1" style={this.styles.button}> Play Online </a>
								<a key="0_2" style={this.styles.button}> View On GitHub </a>
							</FlexLayout>
					...
					<GridItem>
						<div style={this.styles.card} >
							...
							<FlexLayout justify="end" style={{marginTop: 10}}>
								<a key="2_1" style={this.styles.button}> View On GitHub </a>
							</FlexLayout>
						</div>	
					</GridItem>
